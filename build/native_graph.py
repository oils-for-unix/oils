...
- Rules for generated code
  - for build.ninja
  - _build/oil-native.sh - this is generated by build/dev.sh oil-cpp, which
    also generates ASDL.  We could fold that in.
- Could fold bloaty reports in here?  For both Clang and GCC
  - depends on the symbolized, optimized file
- To fix ovm-build benchmark, _build/oil-native.sh should take $compiler and
  $variant
  - It will still test a serial build, because that's what the user gets

- Fix spec-cpp regression

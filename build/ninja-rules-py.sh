...
MYPY_VERSION=0.780
NEW_MYPY_WEDGE=$USER_WEDGE_DIR/pkg/mypy/$MYPY_VERSION
OLD_MYPY_WEDGE=../oils.DEPS/wedge/mypy/$MYPY_VERSION

PY3_LIBS_VERSION=2023-03-04
site_packages=lib/python3.10/site-packages

NEW_PY3_LIBS_WEDGE=../oils.DEPS/wedge/py3-libs/$PY3_LIBS_VERSION/$site_packages
OLD_PY3_LIBS_WEDGE=$USER_WEDGE_DIR/pkg/py3-libs/$PY3_LIBS_VERSION/$site_packages

PYTHONPATH="$REPO_ROOT:$NEW_MYPY_WEDGE:$NEW_PY3_LIBS_WEDGE:$OLD_MYPY_WEDGE:$OLD_PY3_LIBS_WEDGE" MYPYPATH="$MYPYPATH" \

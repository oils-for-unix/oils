...
def mycpp_bin(ru, cc_lib, template='unix', matrix=None, bin_path=None, symlinks=None, preprocessed=False, phony_prefix=None):
    matrix = matrix or []
    ...
    ru.cc_binary(main_cc_path, deps=[cc_lib], matrix=matrix, bin_path=bin_path, symlinks=symlinks,preprocessed=preprocessed, phony_prefix=phony_prefix)

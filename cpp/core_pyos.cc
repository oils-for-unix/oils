...
void
complain_loudly_on_segfault_handler(int sig, siginfo_t *si, void *data)
{
...
Dict<Str*, Str*>* Environ() {
  ...
  // NOTE(Jesse): I put this in here because it just happens to be the first
  // hand-written C++ I could find that the osh interpreter calls into.
  complain_loudly_on_segfault();

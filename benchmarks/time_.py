...
def Options():
    ...
    p.add_option('--time-span',
                 ...
                 default=False,
                 action='store_true',
                 help='Also show start_time and end_time')
    p.add_option('-o',
                 '--output',
                 dest='output',
                 default=None,
...
def main(argv):
    ...
    if opts.print_header:
        ...
        if opts.rusage_2:
            names.extend([
                'minor_faults', 'major_faults', 'swaps', 'in_block',
                'out_block', 'signals', 'voluntary_ctx', 'involuntary_ctx'
            ])
        if opts.stdout:
    ...
    if opts.output:
        ...
        pass
        # Somehow this doesn't work?  Getting binary data?

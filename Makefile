...
_build/hello/bytecode.zip: $(HELLO_SRCS) \
	...
	{ echo 'build/testdata/hello-version.txt hello-version.txt'; \
	  echo '_build/build-date.txt build-date.txt'; \
	  cat build/testdata/hello-manifest.txt _build/hello/app-deps-py.txt \
	      _build/runpy-deps-py.txt; \
	} | build/make_zip.py $@
...
_build/oil/bytecode.zip: oil-version.txt \
	...
	{ echo 'oil-version.txt oil-version.txt'; \
	  echo '_build/build-date.txt build-date.txt'; \
	  cat build/oil-manifest.txt _build/oil/app-deps-py.txt \
	      _build/runpy-deps-py.txt; \
	} | build/make_zip.py $@ 

...
class MutableOpts(object):
    ...
    def _SetArrayByNum(self, opt_num, b):
        # type: (int, bool) -> None
        if (opt_num in consts.PARSE_OPTION_NUMS
                and not self.mem.ParsingChangesAllowed()):
            ...
            for frame in reversed(self.debug_stack):
                ...
                with tagswitch(frame) as case:
                    if case(debug_frame_e.Call):
                        ...
                        strs.append(
                            'source')  # bash doesn't tell you the filename.
            ...
            for frame in reversed(self.debug_stack):
                ...
                with tagswitch(frame) as case:
                    if case(debug_frame_e.Call):
                        ...
                        strs.append(
                            '0')  # Bash does this to line up with 'main'

...
Pass --rcfile /dev/null or --norc to disable this behavior. The latter also disables --rcdir.
...
Pass --rcdir /dev/null or --norc to disable this behavior. The latter also disables --rcfile.

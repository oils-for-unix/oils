...
See [sh-array][] for the initialization.  In YSH, prefer to use [List](#List) instances.
...
See [sh-assoc][] for the initialization.  In YSH, prefer to use [Dict](#Dict) instances.

...
target-lang() {
  ...
  cpp-compile demo/target_lang.cc $bin ../cpp/dumb_alloc_leaky.cc gc_heap.cc -I ../cpp
  $bin "$@"
}
...
target-lang-m32() {
  ...
  $CXX -o $bin $BASE_CXXFLAGS -m32 \
    demo/target_lang.cc ../cpp/dumb_alloc_leaky.cc -I ../cpp
  $bin "$@"
}
...
open() {
  ...
  cpp-compile demo/open.cc $bin ../cpp/dumb_alloc_leaky.cc -I ../cpp

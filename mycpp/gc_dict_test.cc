...
TEST test_dict_internals() {
  ...
  ASSERT_EQ_FMT(Tag::FixedSize, dict1->header_.heap_tag_, "%d");
  ASSERT_EQ_FMT(Tag::FixedSize, dict1->header_.heap_tag_, "%d");
  ...
  ASSERT_EQ_FMT(32, dict1->entry_->header_.obj_len_, "%d");
  ASSERT_EQ_FMT(32, dict1->keys_->header_.obj_len_, "%d");
  ASSERT_EQ_FMT(32, dict1->values_->header_.obj_len_, "%d");
  ...
  ASSERT_EQ_FMT(32, dict2->entry_->header_.obj_len_, "%d");
  ASSERT_EQ_FMT(64, dict2->keys_->header_.obj_len_, "%d");
  ASSERT_EQ_FMT(64, dict2->values_->header_.obj_len_, "%d");
  ...
  ASSERT_EQ_FMT(32, dict_si->entry_->header_.obj_len_, "%d");
  ASSERT_EQ_FMT(64, dict_si->keys_->header_.obj_len_, "%d");
  ASSERT_EQ_FMT(32, dict_si->values_->header_.obj_len_, "%d");
  ...
  ASSERT_EQ_FMT(32, dict_is->entry_->header_.obj_len_, "%d");
  ASSERT_EQ_FMT(32, dict_is->keys_->header_.obj_len_, "%d");
  ASSERT_EQ_FMT(64, dict_is->values_->header_.obj_len_, "%d");

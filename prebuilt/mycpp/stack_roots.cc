...
namespace souffle::t_btree_000_iii__0_2__0_1_2__101__110__111 {
...
t_btree_000_iii__0_2__0_1_2__101__110__111::Type* rel_cf_edge_4931a04c8c74bb72;
};
} // namespace  souffle
namespace  souffle {
using namespace souffle;
...
signalHandler->setMsg(R"_(cf_path(f,x,y) :- 
   cf_edge(f,x,y).
in file stack_roots.dl [60:1-60:38])_");
...
signalHandler->setMsg(R"_(cf_path(f,x,y) :- 
   cf_path(f,x,z),
   cf_edge(f,z,y).
in file stack_roots.dl [62:1-62:56])_");
...
std::string& inputDirectory;
std::string& outputDirectory;
t_btree_000_ii__0_1__11::Type* rel_collect_092686b367d9983d;
};
} // namespace  souffle
namespace  souffle {
using namespace souffle;
...
public:
 Stratum_live_vars_in_a363f2025538826a(SymbolTable& symTable,RecordTable& recordTable,ConcurrentCache<std::string,std::regex>& regexCache,bool& pruneImdtRels,bool& performIO,SignalHandler*& signalHandler,std::atomic<std::size_t>& iter,std::atomic<RamDomain>& ctr,std::string& inputDirectory,std::string& outputDirectory,t_btree_000_iii__0_1_2__110__111::Type& rel_delta_live_vars_in_fccc4ee6df066f63,t_btree_000_iii__0_1_2__110__111::Type& rel_delta_live_vars_out_acc66913cea62d16,t_btree_000_iii__0_1_2__110__111::Type& rel_new_live_vars_in_0b01be53183b2351,t_btree_000_iii__0_1_2__110__111::Type& rel_new_live_vars_out_2d78073638bb3740,t_btree_000_iii__0_2__0_1_2__101__110__111::Type& rel_cf_edge_4931a04c8c74bb72,t_btree_000_ii__0_1__11::Type& rel_collect_092686b367d9983d,t_btree_000_iii__0_1_2__111::Type& rel_def_a2557aec54a7a800,t_btree_000_iii__0_2_1__101__111::Type& rel_live_vars_in_0b002b95687eda95,t_btree_000_iii__0_1_2__111::Type& rel_live_vars_out_f94306e028b67aa4,t_btree_000_iii__0_1_2__111::Type& rel_use_e955e932f22dad4d);
void run([[maybe_unused]] const std::vector<RamDomain>& args,[[maybe_unused]] std::vector<RamDomain>& ret);
private:
SymbolTable& symTable;
RecordTable& recordTable;
...
std::string& inputDirectory;
std::string& outputDirectory;
t_btree_000_iii__0_1_2__110__111::Type* rel_delta_live_vars_in_fccc4ee6df066f63;
t_btree_000_iii__0_1_2__110__111::Type* rel_delta_live_vars_out_acc66913cea62d16;
t_btree_000_iii__0_1_2__110__111::Type* rel_new_live_vars_in_0b01be53183b2351;
t_btree_000_iii__0_1_2__110__111::Type* rel_new_live_vars_out_2d78073638bb3740;
t_btree_000_iii__0_2__0_1_2__101__110__111::Type* rel_cf_edge_4931a04c8c74bb72;
t_btree_000_ii__0_1__11::Type* rel_collect_092686b367d9983d;
t_btree_000_iii__0_1_2__111::Type* rel_def_a2557aec54a7a800;
t_btree_000_iii__0_2_1__101__111::Type* rel_live_vars_in_0b002b95687eda95;
t_btree_000_iii__0_1_2__111::Type* rel_live_vars_out_f94306e028b67aa4;
t_btree_000_iii__0_1_2__111::Type* rel_use_e955e932f22dad4d;
};
} // namespace  souffle
namespace  souffle {
...
signalHandler->setMsg(R"_(live_vars_in(f,x,v) :- 
   use(f,x,v).
in file stack_roots.dl [66:1-66:38])_");
...
signalHandler->setMsg(R"_(live_vars_in(f,x,v) :- 
   !def(f,x,v),
   live_vars_out(f,x,v).
in file stack_roots.dl [69:1-69:62])_");
...
if( !(rel_live_vars_in_0b002b95687eda95->contains(Tuple<RamDomain,3>{{ramBitCast(env0[0]),ramBitCast(env0[1]),ramBitCast(env0[2])}},READ_OP_CONTEXT(rel_live_vars_in_0b002b95687eda95_op_ctxt))) && !(rel_def_a2557aec54a7a800->contains(Tuple<RamDomain,3>{{ramBitCast(env0[0]),ramBitCast(env0[1]),ramBitCast(env0[2])}},READ_OP_CONTEXT(rel_def_a2557aec54a7a800_op_ctxt)))) {
Tuple<RamDomain,3> tuple{{ramBitCast(env0[0]),ramBitCast(env0[1]),ramBitCast(env0[2])}};
...
signalHandler->setMsg(R"_(live_vars_in(f,x,v) :- 
   ...
   cf_edge(f,y,x),
   live_vars_out(f,y,v).
in file stack_roots.dl [72:1-72:82])_");
if(!(rel_cf_edge_4931a04c8c74bb72->empty()) && !(rel_delta_live_vars_out_acc66913cea62d16->empty()) && !(rel_collect_092686b367d9983d->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_delta_live_vars_out_acc66913cea62d16_op_ctxt,rel_delta_live_vars_out_acc66913cea62d16->createContext());
CREATE_OP_CONTEXT(rel_new_live_vars_in_0b01be53183b2351_op_ctxt,rel_new_live_vars_in_0b01be53183b2351->createContext());
CREATE_OP_CONTEXT(rel_cf_edge_4931a04c8c74bb72_op_ctxt,rel_cf_edge_4931a04c8c74bb72->createContext());
...
CREATE_OP_CONTEXT(rel_live_vars_in_0b002b95687eda95_op_ctxt,rel_live_vars_in_0b002b95687eda95->createContext());
for(const auto& env0 : *rel_collect_092686b367d9983d) {
auto range = rel_cf_edge_4931a04c8c74bb72->lowerUpperRange_101(Tuple<RamDomain,3>{{ramBitCast(env0[0]), ramBitCast<RamDomain>(MIN_RAM_SIGNED), ramBitCast(env0[1])}},Tuple<RamDomain,3>{{ramBitCast(env0[0]), ramBitCast<RamDomain>(MAX_RAM_SIGNED), ramBitCast(env0[1])}},READ_OP_CONTEXT(rel_cf_edge_4931a04c8c74bb72_op_ctxt));
for(const auto& env1 : range) {
auto range = rel_delta_live_vars_out_acc66913cea62d16->lowerUpperRange_110(Tuple<RamDomain,3>{{ramBitCast(env0[0]), ramBitCast(env1[1]), ramBitCast<RamDomain>(MIN_RAM_SIGNED)}},Tuple<RamDomain,3>{{ramBitCast(env0[0]), ramBitCast(env1[1]), ramBitCast<RamDomain>(MAX_RAM_SIGNED)}},READ_OP_CONTEXT(rel_delta_live_vars_out_acc66913cea62d16_op_ctxt));
for(const auto& env2 : range) {
if( !(rel_live_vars_in_0b002b95687eda95->contains(Tuple<RamDomain,3>{{ramBitCast(env0[0]),ramBitCast(env0[1]),ramBitCast(env2[2])}},READ_OP_CONTEXT(rel_live_vars_in_0b002b95687eda95_op_ctxt)))) {
...
();}
signalHandler->setMsg(R"_(live_vars_out(f,x,v) :- 
   cf_edge(f,x,y),
   live_vars_in(f,y,v).
in file stack_roots.dl [76:1-76:66])_");
...
public:
 Stratum_root_vars_d910841585fde373(SymbolTable& symTable,RecordTable& recordTable,ConcurrentCache<std::string,std::regex>& regexCache,bool& pruneImdtRels,bool& performIO,SignalHandler*& signalHandler,std::atomic<std::size_t>& iter,std::atomic<RamDomain>& ctr,std::string& inputDirectory,std::string& outputDirectory,t_btree_000_iii__0_1_2__111::Type& rel_cf_path_018f9b04e61e101f,t_btree_000_ii__0_1__11::Type& rel_collect_092686b367d9983d,t_btree_000_iii__0_2_1__101__111::Type& rel_live_vars_in_0b002b95687eda95,t_btree_000_ii__0_1__11::Type& rel_root_vars_9dd5ee9984886e0d,t_btree_000_iii__0_1_2__111::Type& rel_use_e955e932f22dad4d);
void run([[maybe_unused]] const std::vector<RamDomain>& args,[[maybe_unused]] std::vector<RamDomain>& ret);
private:
SymbolTable& symTable;
RecordTable& recordTable;
...
CREATE_OP_CONTEXT(rel_use_e955e932f22dad4d_op_ctxt,rel_use_e955e932f22dad4d->createContext());
for(const auto& env0 : *rel_use_e955e932f22dad4d) {
auto range = rel_live_vars_in_0b002b95687eda95->lowerUpperRange_101(Tuple<RamDomain,3>{{ramBitCast(env0[0]), ramBitCast<RamDomain>(MIN_RAM_SIGNED), ramBitCast(env0[2])}},Tuple<RamDomain,3>{{ramBitCast(env0[0]), ramBitCast<RamDomain>(MAX_RAM_SIGNED), ramBitCast(env0[2])}},READ_OP_CONTEXT(rel_live_vars_in_0b002b95687eda95_op_ctxt));
for(const auto& env1 : range) {
if( rel_collect_092686b367d9983d->contains(Tuple<RamDomain,2>{{ramBitCast(env0[0]),ramBitCast(env1[1])}},READ_OP_CONTEXT(rel_collect_092686b367d9983d_op_ctxt)) && rel_cf_path_018f9b04e61e101f->contains(Tuple<RamDomain,3>{{ramBitCast(env0[0]),ramBitCast(env1[1]),ramBitCast(env0[1])}},READ_OP_CONTEXT(rel_cf_path_018f9b04e61e101f_op_ctxt))) {
...
ConcurrentCache<std::string,std::regex> regexCache;
Own<t_btree_000_iii__0_2__0_1_2__101__110__111::Type> rel_cf_edge_4931a04c8c74bb72;
souffle::RelationWrapper<t_btree_000_iii__0_2__0_1_2__101__110__111::Type> wrapper_rel_cf_edge_4931a04c8c74bb72;
Own<t_btree_000_ii__0_1__11::Type> rel_collect_092686b367d9983d;
souffle::RelationWrapper<t_btree_000_ii__0_1__11::Type> wrapper_rel_collect_092686b367d9983d;
...
Own<t_btree_000_iii__0_2_1__101__111::Type> rel_live_vars_in_0b002b95687eda95;
souffle::RelationWrapper<t_btree_000_iii__0_2_1__101__111::Type> wrapper_rel_live_vars_in_0b002b95687eda95;
Own<t_btree_000_iii__0_1_2__110__111::Type> rel_new_live_vars_in_0b01be53183b2351;
Own<t_btree_000_iii__0_1_2__110__111::Type> rel_delta_live_vars_in_fccc4ee6df066f63;
Own<t_btree_000_iii__0_1_2__111::Type> rel_live_vars_out_f94306e028b67aa4;
souffle::RelationWrapper<t_btree_000_iii__0_1_2__111::Type> wrapper_rel_live_vars_out_f94306e028b67aa4;
Own<t_btree_000_iii__0_1_2__110__111::Type> rel_new_live_vars_out_2d78073638bb3740;
Own<t_btree_000_iii__0_1_2__110__111::Type> rel_delta_live_vars_out_acc66913cea62d16;
...
recordTable(),
regexCache(),
rel_cf_edge_4931a04c8c74bb72(mk<t_btree_000_iii__0_2__0_1_2__101__110__111::Type>()),
...
rel_collect_092686b367d9983d(mk<t_btree_000_ii__0_1__11::Type>()),
...
rel_live_vars_in_0b002b95687eda95(mk<t_btree_000_iii__0_2_1__101__111::Type>()),
wrapper_rel_live_vars_in_0b002b95687eda95(5, *rel_live_vars_in_0b002b95687eda95, *this, "live_vars_in", std::array<const char *,3>{{"s:Function","s:Statement","s:Var"}}, std::array<const char *,3>{{"f","x","v"}}, 0),
rel_new_live_vars_in_0b01be53183b2351(mk<t_btree_000_iii__0_1_2__110__111::Type>()),
rel_delta_live_vars_in_fccc4ee6df066f63(mk<t_btree_000_iii__0_1_2__110__111::Type>()),
rel_live_vars_out_f94306e028b67aa4(mk<t_btree_000_iii__0_1_2__111::Type>()),
wrapper_rel_live_vars_out_f94306e028b67aa4(6, *rel_live_vars_out_f94306e028b67aa4, *this, "live_vars_out", std::array<const char *,3>{{"s:Function","s:Statement","s:Var"}}, std::array<const char *,3>{{"f","x","v"}}, 0),
rel_new_live_vars_out_2d78073638bb3740(mk<t_btree_000_iii__0_1_2__110__111::Type>()),
rel_delta_live_vars_out_acc66913cea62d16(mk<t_btree_000_iii__0_1_2__110__111::Type>()),
rel_root_vars_9dd5ee9984886e0d(mk<t_btree_000_ii__0_1__11::Type>()),
wrapper_rel_root_vars_9dd5ee9984886e0d(7, *rel_root_vars_9dd5ee9984886e0d, *this, "root_vars", std::array<const char *,2>{{"s:Function","s:Var"}}, std::array<const char *,2>{{"f","v"}}, 0),
...
stratum_live_vars_in_c3dc49a4823a7f1e(symTable,recordTable,regexCache,pruneImdtRels,performIO,signalHandler,iter,ctr,inputDirectory,outputDirectory,*rel_delta_live_vars_in_fccc4ee6df066f63,*rel_delta_live_vars_out_acc66913cea62d16,*rel_new_live_vars_in_0b01be53183b2351,*rel_new_live_vars_out_2d78073638bb3740,*rel_cf_edge_4931a04c8c74bb72,*rel_collect_092686b367d9983d,*rel_def_a2557aec54a7a800,*rel_live_vars_in_0b002b95687eda95,*rel_live_vars_out_f94306e028b67aa4,*rel_use_e955e932f22dad4d),
stratum_root_vars_19aeb1b6f3a71208(symTable,recordTable,regexCache,pruneImdtRels,performIO,signalHandler,iter,ctr,inputDirectory,outputDirectory,*rel_cf_path_018f9b04e61e101f,*rel_collect_092686b367d9983d,*rel_live_vars_in_0b002b95687eda95,*rel_root_vars_9dd5ee9984886e0d,*rel_use_e955e932f22dad4d),

...
signalHandler->setMsg(R"_(CFGraph.edge(f,s1,f,s2) :- 
   cf_edge(f,s1,s2).
in file stack_roots.dl [76:1-76:50])_");
...
signalHandler->setMsg(R"_(CFGraph.edge(f,s1,g,0) :- 
   call([f,s1],g).
in file stack_roots.dl [77:1-77:47])_");
...
namespace  souffle {
using namespace souffle;
class Stratum_CFGraph_node_8b9740f56fe4ce98 {
public:
 Stratum_CFGraph_node_8b9740f56fe4ce98(SymbolTable& symTable,RecordTable& recordTable,ConcurrentCache<std::string,std::regex>& regexCache,bool& pruneImdtRels,bool& performIO,SignalHandler*& signalHandler,std::atomic<std::size_t>& iter,std::atomic<RamDomain>& ctr,std::string& inputDirectory,std::string& outputDirectory,t_btree_000_iiii__0_1_2__3_0_1_2__1110__1111__0001::Type& rel_CFGraph_edge_db08b41d50d8a475,t_btree_000_ii__0_1__11::Type& rel_CFGraph_node_15a66ec36a3b579d);
void run([[maybe_unused]] const std::vector<RamDomain>& args,[[maybe_unused]] std::vector<RamDomain>& ret);
private:
SymbolTable& symTable;
RecordTable& recordTable;
...
std::string& outputDirectory;
t_btree_000_iiii__0_1_2__3_0_1_2__1110__1111__0001::Type* rel_CFGraph_edge_db08b41d50d8a475;
t_btree_000_ii__0_1__11::Type* rel_CFGraph_node_15a66ec36a3b579d;
};
} // namespace  souffle
namespace  souffle {
using namespace souffle;
 Stratum_CFGraph_node_8b9740f56fe4ce98::Stratum_CFGraph_node_8b9740f56fe4ce98(SymbolTable& symTable,RecordTable& recordTable,ConcurrentCache<std::string,std::regex>& regexCache,bool& pruneImdtRels,bool& performIO,SignalHandler*& signalHandler,std::atomic<std::size_t>& iter,std::atomic<RamDomain>& ctr,std::string& inputDirectory,std::string& outputDirectory,t_btree_000_iiii__0_1_2__3_0_1_2__1110__1111__0001::Type& rel_CFGraph_edge_db08b41d50d8a475,t_btree_000_ii__0_1__11::Type& rel_CFGraph_node_15a66ec36a3b579d):
symTable(symTable),
recordTable(recordTable),
regexCache(regexCache),
pruneImdtRels(pruneImdtRels),
...
outputDirectory(outputDirectory),
rel_CFGraph_edge_db08b41d50d8a475(&rel_CFGraph_edge_db08b41d50d8a475),
rel_CFGraph_node_15a66ec36a3b579d(&rel_CFGraph_node_15a66ec36a3b579d){
}

void Stratum_CFGraph_node_8b9740f56fe4ce98::run([[maybe_unused]] const std::vector<RamDomain>& args,[[maybe_unused]] std::vector<RamDomain>& ret){
signalHandler->setMsg(R"_(CFGraph.node(f,s) :- 
   CFGraph.edge(f,s,_,_).
in file stack_roots.dl [21:2-21:33])_");
if(!(rel_CFGraph_edge_db08b41d50d8a475->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_CFGraph_edge_db08b41d50d8a475_op_ctxt,rel_CFGraph_edge_db08b41d50d8a475->createContext());
CREATE_OP_CONTEXT(rel_CFGraph_node_15a66ec36a3b579d_op_ctxt,rel_CFGraph_node_15a66ec36a3b579d->createContext());
for(const auto& env0 : *rel_CFGraph_edge_db08b41d50d8a475) {
Tuple<RamDomain,2> tuple{{ramBitCast(env0[0]),ramBitCast(env0[1])}};
rel_CFGraph_node_15a66ec36a3b579d->insert(tuple,READ_OP_CONTEXT(rel_CFGraph_node_15a66ec36a3b579d_op_ctxt));
}
}
();}
signalHandler->setMsg(R"_(CFGraph.node(f,s) :- 
   CFGraph.edge(_,_,f,s).
in file stack_roots.dl [22:2-22:33])_");
if(!(rel_CFGraph_edge_db08b41d50d8a475->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_CFGraph_edge_db08b41d50d8a475_op_ctxt,rel_CFGraph_edge_db08b41d50d8a475->createContext());
CREATE_OP_CONTEXT(rel_CFGraph_node_15a66ec36a3b579d_op_ctxt,rel_CFGraph_node_15a66ec36a3b579d->createContext());
for(const auto& env0 : *rel_CFGraph_edge_db08b41d50d8a475) {
Tuple<RamDomain,2> tuple{{ramBitCast(env0[2]),ramBitCast(env0[3])}};
rel_CFGraph_node_15a66ec36a3b579d->insert(tuple,READ_OP_CONTEXT(rel_CFGraph_node_15a66ec36a3b579d_op_ctxt));
}
}
();}
...
t_btree_000_iiii__0_1_2__3_0_1_2__1110__1111__0001::Type* rel_CFGraph_edge_db08b41d50d8a475;
t_btree_000_ii__0_1__11::Type* rel_CFGraph_node_15a66ec36a3b579d;
t_btree_000_iiii__0_2_3__0_1_2_3__1011__1110__1111::Type* rel_CFGraph_reachable_c344462befee4909;
};
} // namespace  souffle
namespace  souffle {
using namespace souffle;
...
signalHandler->setMsg(R"_(CFGraph.reachable(f,s,"heap",-1) :- 
   CFGraph.node(f,s).
in file stack_roots.dl [78:1-78:59])_");
if(!(rel_CFGraph_node_15a66ec36a3b579d->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_CFGraph_node_15a66ec36a3b579d_op_ctxt,rel_CFGraph_node_15a66ec36a3b579d->createContext());
CREATE_OP_CONTEXT(rel_CFGraph_reachable_c344462befee4909_op_ctxt,rel_CFGraph_reachable_c344462befee4909->createContext());
for(const auto& env0 : *rel_CFGraph_node_15a66ec36a3b579d) {
Tuple<RamDomain,4> tuple{{ramBitCast(env0[0]),ramBitCast(env0[1]),ramBitCast(RamSigned(0)),ramBitCast(RamSigned(-1))}};
...
in file stack_roots.dl [24:2-24:48])_");
if(!(rel_CFGraph_edge_db08b41d50d8a475->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_CFGraph_edge_db08b41d50d8a475_op_ctxt,rel_CFGraph_edge_db08b41d50d8a475->createContext());
CREATE_OP_CONTEXT(rel_CFGraph_reachable_c344462befee4909_op_ctxt,rel_CFGraph_reachable_c344462befee4909->createContext());
...
in file stack_roots.dl [25:2-25:73])_");
...
in file stack_roots.dl [26:2-26:96])_");
...
if (pruneImdtRels) rel_CFGraph_node_15a66ec36a3b579d->purge();
}
...
signalHandler->setMsg(R"_(alias([f,s1],$Variable(v),[f,s2],$Variable(v2)) :- 
   ...
   CFGraph.reachable(f,s1,f,s2).
in file stack_roots.dl [97:1-100:34])_");
...
)),ramBitCast(pack(recordTable,Tuple<RamDomain,2>{{ramBitCast(ramBitCast(env1[0])),ramBitCast(ramBitCast(env4[1]))}}
...
signalHandler->setMsg(R"_(alias(["heap",-1],$Member(c, m),[f,s2],r) :- 
   assign([_<unnamed_1>,_<unnamed_2>],$Member(c, m),_),
   assign([f,s2],r,$Member(c, m)).
in file stack_roots.dl [103:1-105:36])_");
...
{
for(const auto& env4 : *rel_assign_e4bb6e0824a16a37) {
...
const RamDomain *env6 = recordTable.unpack(ref,2);
{
if( (ramBitCast<RamDomain>(env6[0]) == ramBitCast<RamDomain>(RamSigned(0)))) {
RamDomain const ref = env6[1];
if (ref == 0) continue;
const RamDomain *env7 = recordTable.unpack(ref,2);
{
if( (ramBitCast<RamDomain>(env3[1]) == ramBitCast<RamDomain>(env7[1])) && (ramBitCast<RamDomain>(env3[0]) == ramBitCast<RamDomain>(env7[0]))) {
Tuple<RamDomain,4> tuple{{ramBitCast(pack(recordTable,Tuple<RamDomain,2>{{ramBitCast(ramBitCast(RamSigned(0))),ramBitCast(ramBitCast(RamSigned(-1)))}}
...
)),ramBitCast(pack(recordTable,Tuple<RamDomain,2>{{ramBitCast(ramBitCast(env5[0])),ramBitCast(ramBitCast(env5[1]))}}
)),ramBitCast(env4[1])}};
rel_alias_36893f0f24e80d93->insert(tuple,READ_OP_CONTEXT(rel_alias_36893f0f24e80d93_op_ctxt));
}
}
...
signalHandler->setMsg(R"_(alias([f,s1],$Variable(v),["heap",-1],$Member(c, m)) :- 
   ...
   CFGraph.reachable(f,s1,f,s2).
in file stack_roots.dl [108:1-111:34])_");
if(!(rel_assign_e4bb6e0824a16a37->empty()) && !(rel_CFGraph_reachable_c344462befee4909->empty()) && !(rel_def_a2557aec54a7a800->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_CFGraph_reachable_c344462befee4909_op_ctxt,rel_CFGraph_reachable_c344462befee4909->createContext());
CREATE_OP_CONTEXT(rel_alias_36893f0f24e80d93_op_ctxt,rel_alias_36893f0f24e80d93->createContext());
...
)),ramBitCast(pack(recordTable,Tuple<RamDomain,2>{{ramBitCast(ramBitCast(RamSigned(0))),ramBitCast(ramBitCast(RamSigned(-1)))}}
...
signalHandler->setMsg(R"_(alias([f,s1],$Variable(v),[g,0],$Variable(v2)) :- 
   ...
   CFGraph.reachable(f,s1,f,s2).
in file stack_roots.dl [114:1-117:34])_");
...
iter = 0;
for(;;) {
signalHandler->setMsg(R"_(alias([f,s1],r1,[h,s2],r3) :- 
   alias([f,s1],r1,[_<unnamed_1>,_<unnamed_2>],r2),
   alias([_<unnamed_3>,_<unnamed_4>],r2,[h,s2],r3).
in file stack_roots.dl [119:1-121:33])_");
...
)),ramBitCast(env0[3]),ramBitCast(pack(recordTable,Tuple<RamDomain,2>{{ramBitCast(ramBitCast(env5[0])),ramBitCast(ramBitCast(env5[1]))}}
)),ramBitCast(env3[3])}},READ_OP_CONTEXT(rel_delta_alias_1a64c49de7b5c1e9_op_ctxt))) && !(rel_alias_36893f0f24e80d93->contains(Tuple<RamDomain,4>{{ramBitCast(pack(recordTable,Tuple<RamDomain,2>{{ramBitCast(ramBitCast(env1[0])),ramBitCast(ramBitCast(env1[1]))}}
)),ramBitCast(env0[1]),ramBitCast(pack(recordTable,Tuple<RamDomain,2>{{ramBitCast(ramBitCast(env5[0])),ramBitCast(ramBitCast(env5[1]))}}
)),ramBitCast(env3[3])}},READ_OP_CONTEXT(rel_alias_36893f0f24e80d93_op_ctxt)))) {
Tuple<RamDomain,4> tuple{{ramBitCast(pack(recordTable,Tuple<RamDomain,2>{{ramBitCast(ramBitCast(env1[0])),ramBitCast(ramBitCast(env1[1]))}}
)),ramBitCast(env0[1]),ramBitCast(pack(recordTable,Tuple<RamDomain,2>{{ramBitCast(ramBitCast(env5[0])),ramBitCast(ramBitCast(env5[1]))}}
)),ramBitCast(env3[3])}};
...
signalHandler->setMsg(R"_(def(l,r) :- 
   assign(l,r,_).
in file stack_roots.dl [129:1-129:30])_");
if(!(rel_assign_e4bb6e0824a16a37->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_assign_e4bb6e0824a16a37_op_ctxt,rel_assign_e4bb6e0824a16a37->createContext());
CREATE_OP_CONTEXT(rel_def_a2557aec54a7a800_op_ctxt,rel_def_a2557aec54a7a800->createContext());
...
signalHandler->setMsg(R"_(escaped_vars(f,v) :- 
   alias([f,_<unnamed_1>],$Variable(v),[g,_<unnamed_2>],_),
   f != g.
in file stack_roots.dl [123:1-124:49])_");
...
for(;;) {
signalHandler->setMsg(R"_(escaped_vars(f,v) :- 
   alias([f,_<unnamed_1>],$Variable(v),[f,_<unnamed_2>],$Variable(v2)),
   escaped_vars(f,v2).
in file stack_roots.dl [125:1-127:22])_");
...
const RamDomain *env2 = recordTable.unpack(ref,2);
{
if( (ramBitCast<RamDomain>(env2[0]) == ramBitCast<RamDomain>(RamSigned(1))) && !(rel_escaped_vars_add75fa556d724cf->contains(Tuple<RamDomain,2>{{ramBitCast(env1[0]),ramBitCast(env2[1])}},READ_OP_CONTEXT(rel_escaped_vars_add75fa556d724cf_op_ctxt)))) {
RamDomain const ref = env0[2];
if (ref == 0) continue;
const RamDomain *env3 = recordTable.unpack(ref,2);
{
...
const RamDomain *env4 = recordTable.unpack(ref,2);
{
if( (ramBitCast<RamDomain>(env4[0]) == ramBitCast<RamDomain>(RamSigned(1))) && rel_delta_escaped_vars_b4d4991ffe2efcc3->contains(Tuple<RamDomain,2>{{ramBitCast(env1[0]),ramBitCast(env4[1])}},READ_OP_CONTEXT(rel_delta_escaped_vars_b4d4991ffe2efcc3_op_ctxt))) {
Tuple<RamDomain,2> tuple{{ramBitCast(env1[0]),ramBitCast(env2[1])}};
...
rel_new_escaped_vars_5f79dec3be1f3cab->purge();
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","f\tv"},{"auxArity","0"},{"name","escaped_vars"},{"operation","output"},{"output-dir","."},{"params","{\"records\": {\"Location\": {\"arity\": 2, \"params\": [\"func\", \"stmt\"]}}, \"relation\": {\"arity\": 2, \"params\": [\"f\", \"v\"]}}"},{"types","{\"ADTs\": {\"+:Reference\": {\"arity\": 2, \"branches\": [{\"name\": \"Member\", \"types\": [\"s:symbol\", \"s:symbol\"]}, {\"name\": \"Variable\", \"types\": [\"s:symbol\"]}], \"enum\": false}}, \"records\": {\"r:Location\": {\"arity\": 2, \"types\": [\"s:Function\", \"i:Statement\"]}}, \"relation\": {\"arity\": 2, \"types\": [\"s:Function\", \"s:symbol\"]}}"}});
if (outputDirectory == "-"){directiveMap["IO"] = "stdout"; directiveMap["headers"] = "true";}
else if (!outputDirectory.empty()) {directiveMap["output-dir"] = outputDirectory;}
...
t_btree_000_ii__0_1__11::Type* rel_use_e955e932f22dad4d;
};
} // namespace  souffle
namespace  souffle {
using namespace souffle;
...
in file stack_roots.dl [88:1-93:32])_");
...
public:
 Stratum_use_f38e4ba456a0cc9a(SymbolTable& symTable,RecordTable& recordTable,ConcurrentCache<std::string,std::regex>& regexCache,bool& pruneImdtRels,bool& performIO,SignalHandler*& signalHandler,std::atomic<std::size_t>& iter,std::atomic<RamDomain>& ctr,std::string& inputDirectory,std::string& outputDirectory,t_btree_000_ii__0_1__11::Type& rel_use_e955e932f22dad4d);
void run([[maybe_unused]] const std::vector<RamDomain>& args,[[maybe_unused]] std::vector<RamDomain>& ret);
private:
SymbolTable& symTable;
RecordTable& recordTable;
...
Own<t_btree_000_ii__0_1__11::Type> rel_use_e955e932f22dad4d;
souffle::RelationWrapper<t_btree_000_ii__0_1__11::Type> wrapper_rel_use_e955e932f22dad4d;
...
Own<t_btree_000_ii__0_1__11::Type> rel_CFGraph_node_15a66ec36a3b579d;
souffle::RelationWrapper<t_btree_000_ii__0_1__11::Type> wrapper_rel_CFGraph_node_15a66ec36a3b579d;
Own<t_btree_000_iiii__0_2_3__0_1_2_3__1011__1110__1111::Type> rel_CFGraph_reachable_c344462befee4909;
souffle::RelationWrapper<t_btree_000_iiii__0_2_3__0_1_2_3__1011__1110__1111::Type> wrapper_rel_CFGraph_reachable_c344462befee4909;
...
Stratum_CFGraph_node_8b9740f56fe4ce98 stratum_CFGraph_node_d7f060b79f0b5d0b;
...
rel_use_e955e932f22dad4d(mk<t_btree_000_ii__0_1__11::Type>()),
...
rel_CFGraph_node_15a66ec36a3b579d(mk<t_btree_000_ii__0_1__11::Type>()),
wrapper_rel_CFGraph_node_15a66ec36a3b579d(8, *rel_CFGraph_node_15a66ec36a3b579d, *this, "CFGraph.node", std::array<const char *,2>{{"s:Function","i:Statement"}}, std::array<const char *,2>{{"f","s"}}, 0),
rel_CFGraph_reachable_c344462befee4909(mk<t_btree_000_iiii__0_2_3__0_1_2_3__1011__1110__1111::Type>()),
wrapper_rel_CFGraph_reachable_c344462befee4909(9, *rel_CFGraph_reachable_c344462befee4909, *this, "CFGraph.reachable", std::array<const char *,4>{{"s:Function","i:Statement","s:Function","i:Statement"}}, std::array<const char *,4>{{"f","u","g","v"}}, 0),
...
wrapper_rel_alias_36893f0f24e80d93(10, *rel_alias_36893f0f24e80d93, *this, "alias", std::array<const char *,4>{{"r:Location","+:Reference","r:Location","+:Reference"}}, std::array<const char *,4>{{"a","vf","b","vg"}}, 0),
...
wrapper_rel_root_vars_9dd5ee9984886e0d(11, *rel_root_vars_9dd5ee9984886e0d, *this, "root_vars", std::array<const char *,2>{{"s:Function","s:symbol"}}, std::array<const char *,2>{{"f","v"}}, 0),
rel_escaped_vars_add75fa556d724cf(mk<t_btree_000_ii__0_1__11::Type>()),
wrapper_rel_escaped_vars_add75fa556d724cf(12, *rel_escaped_vars_add75fa556d724cf, *this, "escaped_vars", std::array<const char *,2>{{"s:Function","s:symbol"}}, std::array<const char *,2>{{"f","v"}}, 0),
...
stratum_CFGraph_node_d7f060b79f0b5d0b(symTable,recordTable,regexCache,pruneImdtRels,performIO,signalHandler,iter,ctr,inputDirectory,outputDirectory,*rel_CFGraph_edge_db08b41d50d8a475,*rel_CFGraph_node_15a66ec36a3b579d),
stratum_CFGraph_reachable_a1359c86b6f7bd73(symTable,recordTable,regexCache,pruneImdtRels,performIO,signalHandler,iter,ctr,inputDirectory,outputDirectory,*rel_delta_CFGraph_reachable_3f3bf343bbb37861,*rel_new_CFGraph_reachable_c98538911662603c,*rel_CFGraph_edge_db08b41d50d8a475,*rel_CFGraph_node_15a66ec36a3b579d,*rel_CFGraph_reachable_c344462befee4909),
...
addRelation("CFGraph.node", wrapper_rel_CFGraph_node_15a66ec36a3b579d, false, false);
...
{
 std::vector<RamDomain> args, ret;
stratum_CFGraph_node_d7f060b79f0b5d0b.run(args, ret);
}
{
 std::vector<RamDomain> args, ret;
